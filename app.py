...
#conn = pymysql.connect(host='tsuts.tskoli.is', port=3306, user='0512023170', passwword='mypasswword', database='0512023170_verk7')
conn = pymysql.connect(host='localhost', port=3306, user='root', password='', database='verk7')
